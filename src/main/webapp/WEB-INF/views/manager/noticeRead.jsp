...
<link href="resources/css/registerUpdate.css" rel="stylesheet">
			...
			<li class="nav-item active"><a class="nav-link collapsed"
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="#">회원 관리</a> <a
							class="collapse-item" href="#">공지사항 관리</a> <a
							class="collapse-item" href="#">고객게시판 관리</a>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">공지사항 읽기 페이지</h1>
					</div>
							...
							<div class="card shadow-lg my-5">
								...
								<div class="card-header">
									<div style="text-align: center; align-content: center;">
										...
										<h4 class="m-0 font-weight-bold text-primary p-2">공지사항 읽기</h4>
									</div>
								</div>
								...
								<div class="card-body">
									<form>
										...
										<div class="form-group row">
											<div class="col-sm-12">
												<textarea readonly class="form-control-plaintext" rows="15"
													id="content"
										...
										<div class="form-group row">
											<div class="col-sm-12">
												...
												<a class="mx-2">첨부파일 없음</a>
											</div>
										</div>

										<!-- 공지사항 목록 보기 -->
										<button type="button" class="btn btn-primary mb-2 col-sm-12">
											<span class="text">공지사항 목록 보기</span>
										</button>
										<br />
