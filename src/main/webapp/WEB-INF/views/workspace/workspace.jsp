					...
					<div class="card shadow p-4 col-xl-8 bg-light">
						...
						<div class="card shadow mb-4 border-bottom-primary">
							...
							<div class="card-body">
								...
								<form name="createWorkForm" method="get"
									onsubmit="writeToServer('${root}')" class="writeForm">
									<div class="o-hidden">
										...
										<!-- 일감 제목 -->
										<div class="pb-3">
											<input type="text" class="form-control workSubject"
												name="workSubject" placeholder="업무명을 입력하세요">
										</div>

										<!-- 일감 내용 -->
										<div class="pb-3">
											<textarea class="form-control workContent" name="workContent"
