               ...
               <div class="card shadow p-4 col-xl-8 bg-light">
                  ...
                  <div class="card shadow mb-4 border-bottom-primary">
                     ...
                     <div class="card-body">
                        ...
                        <form method="get" onsubmit="writeToServer('${root}')" class="writeForm">
                           <div class="o-hidden">
                              ...
                              <div
                                 ...
                                 <!-- 작성자 -->
                                 <b id="workSender" name="workSender">작성자</b>

                                 <!-- 상태 -->
                                 <div class="btn-group btn-group-toggle my-1 workState"
                                    data-toggle="buttons">
                                    <label class="btn btn-primary active"> <input
                                       type="radio" name="workState" id="option1" checked value="요청">요청
                                       
                                    </label> <label class="btn btn-primary"> <input type="radio"
                                       name="workState" id="option2" value="진행">진행
                                    </label> <label class="btn btn-primary"> <input type="radio"
                                       name="workState" id="option3" value="완료">완료
                                    </label>
                                 </div>
                              </div>
                              ...
                              <div
                                 ...
                                 <div>
                                    ...
                                    <!-- 선택된 담당자 -->
                                    <label class="p-2" id="workReceiver" name="workReceiver">이형은</label>
                                 </div>
                              ...
                              <!-- 일감 제목 -->
                              <div class="pb-3">
                                 <input type="text" class="form-control workSubject" name="workSubject"
                                    placeholder="업무명을 입력하세요">
                              </div>

                              <!-- 일감 내용 -->
                              <div class="pb-3">
                                 <textarea class="form-control workContent" name="workContent" placeholder="업무내용을 입력하세요"></textarea>
                              </div>
                  ...
                  <!-- 추가된 일감 3 -->
                  <div id="work-test" class="card shadow mb-4 border-bottom-primary"
                     style="display: none;">
