								...
								<form action="#" method="get" onsubmit="workPost()">
									<div class="o-hidden">
										...
										<div
											...
											<!-- drop down -->
											<div>
												<a>이형은</a> <a href="#" onclick="managerSelect('${root}')" class="text-decoration-none col-sm-3">담당자 변경</a>
										...
										<div id="updateDelete" class="d-flex flex-row-reverse">
											<a class="m-1 text-decoration-none" href="#">수정</a> <a class="m-1 text-decoration-none" href="#">삭제</a>
										</div>
												...
												<div class="right-column ml-2">
													<form id="reply-form" action="/work-reply/write"
														...
														<div class="form-group clearfix">
															<input id="reply-file-select"
																class="form-control float-left" type="file"
																name="reply-file">
														</div>
													</form>
												</div>
