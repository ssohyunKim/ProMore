    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
           <h1 class="h3 mb-0 text-gray-800">프로젝트 글쓰기</h1>
        </div>
...
<!-- 				          	<h4 class="m-0 font-weight-bold text-primary p-2">공지사항 작성</h4> -->
                     ...
                     <div class="card-body">
                        <form>
                           ...
                           <!-- 파일 첨부 -->
                           <div class="form-group row o-hidden">
                              <div class="col-sm-12 justify-content-end">
                              	<span class="icon">
                              	  	<i class="fas fa-paperclip fa-lg"></i>
                              	</span>                          	
                                <!--  <label class="col-form-label mx-2">파일 선택</label> 
                                 <label for="fileUpload" class="btn btn-sm btn-primary">업로드</label>
                                 <input type="file" class="invisible form-control-file" id="fileUpload"> -->
                                 <input type="file" name="" id="" class="" style="width: 70%; margin-left:10px;"/>
                              </div>
                           </div>
